@extends('layouts.frontend_layouts.frontend_main')
@section('content')
        ...
        <div class="categori-menu-slider-wrapper clearfix">
            <div class="categories-menu">
                ...
                <div class="category-menu-list">
                    <ul>
                        <li>
                            <a href="#"><img alt="" src="{{asset('images/frontend_images/icon-img/5.png')}}">Computer & Laptops <i class="pe-7s-angle-right"></i></a>
                            <div class="category-menu-dropdown">
                                ...
                                <div class="mega-banner-img">
                                    <a href="single-product.html">
                                        <img src="{{asset('images/frontend_images/banner/18.jpg')}}" alt="">
                                    </a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <a href="#"><img alt="" src="{{asset('images/frontend_images/icon-img/6.png')}}">Phone & Tablets <i class="pe-7s-angle-right"></i></a>
                            <div class="category-menu-dropdown">
                        ...
                        <li>
                            <a href="#"><img alt="" src="{{asset('images/frontend_images/icon-img/7.png')}}"> Camera & Photos<i class="pe-7s-angle-right"></i></a>
                            <div class="category-menu-dropdown">
                        ...
                        <li>
                            <a href="#"><img alt="" src="{{asset('images/frontend_images/icon-img/8.png')}}">TV & Audio </a>
                        </li>
                        <li>
                            <a href="#"><img alt="" src="{{asset('images/frontend_images/icon-img/9.png')}}"> Game & Play Station</a>
                        </li>
                        <li>
                            <a href="#"><img alt="" src="{{asset('images/frontend_images/icon-img/10.png')}}"> Car Electronics </a>
                        </li>
                        <li>
                            <a href="#"><img alt="" src="{{asset('images/frontend_images/icon-img/11.png')}}"> Accessories </a>
                        </li>
                        <li>
                            <a href="#"><img alt="" src="{{asset('images/frontend_images/icon-img/12.png')}}"> Gadgets</a>
                        </li>
                        <li>
                            <a href="#"><img alt="" src="{{asset('images/frontend_images/icon-img/13.png')}}">Others Equipment</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="menu-slider-wrapper">
                ...
                <div class="slider-area">
                    <div class="slider-active owl-carousel">
                        <div class="single-slider single-slider-hm3 bg-img pt-170 pb-173" style="background-image: url({{asset('images/frontend_images/slider/5.jpg')}})">
                        ...
                        <div class="single-slider single-slider-hm3 bg-img pt-170 pb-173" style="background-image: url({{asset('images/frontend_images/slider/20.jpg')}})">
                            <div class="slider-animation slider-content-style-3 fadeinup-animated">
                                <h2 class="animated">Invention of <br>design platform</h2>
                                <h4 class="animated">Best Product With warranty </h4>
                                <a class="electro-slider-btn btn-hover" href="product-details.html">buy now</a>
        ...
        <div class="custom-row-2">
            <div class="custom-col-style-2 electronic-banner-col-3 mb-30">
                <div class="electronic-banner-wrapper">
                    <img src="{{asset('images/frontend_images/banner/15.jpg')}}" alt="">
            ...
            <div class="custom-col-style-2 electronic-banner-col-3 mb-30">
                <div class="electronic-banner-wrapper">
                    <img src="{{asset('images/frontend_images/banner/16.jpg')}}" alt="">
            ...
            <div class="custom-col-style-2 electronic-banner-col-3 mb-30">
                <div class="electronic-banner-wrapper">
                    <img src="{{asset('images/frontend_images/banner/17.jpg')}}" alt="">
                                    ...
                                    <div class="qwick-view-left">
                                        ...
                                        <div class="quick-view-list nav" role="tablist">
                                            <a class="active" href="#modal1" data-toggle="tab" role="tab">
                                                <img id="quick-view-image" src="{{asset('images/backend_images/products/small/'.$product->image)}}" alt="">
                                            </a>
    ...
    <div class="banner-area wrapper-padding pt-30 pb-95">
        <div class="container-fluid">
            <div class="electro-fexible-banner bg-img" style="background-image: url({{asset('images/frontend_images/banner/19.jpg')}})">
                    ...
                    <div class="best-selling-left">
                        <div class="product-wrapper">
                            <div class="product-img-4">
                                <a href="#"><img src="{{asset('images/frontend_images/product/9.jpg')}}" alt=""></a>
                                <div class="product-action-right">
                                    <a class="animate-top" title="Add To Cart" href="#">
                                        <i class="pe-7s-cart"></i>
                                    </a>
                            ...
                            <div class="coustom-row-3">
                                <div class="custom-col-style-3 custom-col-3">
                                    <div class="product-wrapper mb-6">
                                        <div class="product-img-4">
                                            <a href="#">
                                                <img src="{{asset('images/frontend_images/product/10.jpg')}}" alt="">
                                            </a>
                                            <div class="product-action-right">
                                                <a class="animate-top" title="Add To Cart" href="#">
                                                    <i class="pe-7s-cart"></i>
                                ...
                                <div class="custom-col-style-3 custom-col-3">
                                    <div class="product-wrapper mb-6">
                                        <div class="product-img-4">
                                            <a href="#">
                                                <img src="{{asset('images/frontend_images/product/11.jpg')}}" alt="">
                                            </a>
                                            <div class="product-action-right">
                                                <a class="animate-top" title="Add To Cart" href="#">
                                                    <i class="pe-7s-cart"></i>
                                ...
                                <div class="custom-col-style-3 custom-col-3">
                                    <div class="product-wrapper mb-6">
                                        <div class="product-img-4">
                                            <a href="#">
                                                <img src="{{asset('images/frontend_images/product/12.jpg')}}" alt="">
                                            </a>
                                            <div class="product-action-right">
                                                <a class="animate-top" title="Add To Cart" href="#">
                                                    <i class="pe-7s-cart"></i>
                                ...
                                <div class="custom-col-style-3 custom-col-3">
                                    <div class="product-wrapper mb-6">
                                        <div class="product-img-4">
                                            <a href="#">
                                                <img src="{{asset('images/frontend_images/product/13.jpg')}}" alt="">
                                            </a>
                                            <div class="product-action-right">
                                                <a class="animate-top" title="Add To Cart" href="#">
                                                    <i class="pe-7s-cart"></i>
                                ...
                                <div class="custom-col-style-3 custom-col-3">
                                    <div class="product-wrapper mb-6">
                                        <div class="product-img-4">
                                            <a href="#">
                                                <img src="{{asset('images/frontend_images/product/14.jpg')}}" alt="">
                                            </a>
                                            <div class="product-action-right">
                                                <a class="animate-top" title="Add To Cart" href="#">
                                                    <i class="pe-7s-cart"></i>
                                ...
                                <div class="custom-col-style-3 custom-col-3">
                                    <div class="product-wrapper mb-6">
                                        <div class="product-img-4">
                                            <a href="#">
                                                <img src="{{asset('images/frontend_images/product/15.jpg')}}" alt="">
                                            </a>
                                            <div class="product-action-right">
                                                <a class="animate-top" title="Add To Cart" href="#">
                                                    <i class="pe-7s-cart"></i>
    ...
    <div class="androit-banner-wrapper wrapper-padding pb-175">
        <div class="container-fluid">
            <div class="androit-banner-img bg-img" style="background-image: url({{asset('images/frontend_images/banner/36.jpg')}})">
                ...
                <div class="phn-img">
                    <img src="{{asset('images/frontend_images/banner/10.png')}}" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-xl-4">
                    <div class="product-wrapper product-wrapper-border mb-30">
                        <div class="product-img-5">
                            <a href="#">
                                <img src="{{asset('images/frontend_images/product/16.jpg')}}" alt="">
                            </a>
                        </div>
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="product-wrapper product-wrapper-border mb-30">
                        <div class="product-img-5">
                            <a href="#">
                                <img src="{{asset('images/frontend_images/product/17.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="product-content-7">
                            <h4><a href="#">Autel Robotics - X-Star Premium Quadcopter</a></h4>
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="product-wrapper product-wrapper-border mb-30">
                        <div class="product-img-5">
                            <a href="#">
                                <img src="{{asset('images/frontend_images/product/18.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="product-content-7">
                            <h4><a href="#">Autel Robotics - X-Star Premium Quadcopter</a></h4>
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="product-wrapper product-wrapper-border mb-30">
                        <div class="product-img-5">
                            <a href="#">
                                <img src="{{asset('images/frontend_images/product/19.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="product-content-7">
                            <h4><a href="#">Autel Robotics - X-Star Premium Quadcopter</a></h4>
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="product-wrapper product-wrapper-border mb-30">
                        <div class="product-img-5">
                            <a href="#">
                                <img src="{{asset('images/frontend_images/product/20.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="product-content-7">
                            <h4><a href="#">Autel Robotics - X-Star Premium Quadcopter</a></h4>
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="product-wrapper product-wrapper-border mb-30">
                        <div class="product-img-5">
                            <a href="#">
                                <img src="{{asset('images/frontend_images/product/21.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="product-content-7">
                            <h4><a href="#">Autel Robotics - X-Star Premium Quadcopter</a></h4>
        ...
        <div class="container-fluid">
            <div class="brand-logo-active2 owl-carousel">
                <div class="single-brand">
                    <img src="{{asset('images/frontend_images/brand-logo/7.png')}}" alt="">
                </div>
                <div class="single-brand">
                    <img src="{{asset('images/frontend_images/brand-logo/8.png')}}" alt="">
                </div>
                <div class="single-brand">
                    <img src="{{asset('images/frontend_images/brand-logo/9.png')}}" alt="">
                </div>
                <div class="single-brand">
                    <img src="{{asset('images/frontend_images/brand-logo/10.png')}}" alt="">
                </div>
                <div class="single-brand">
                    <img src="{{asset('images/frontend_images/brand-logo/11.png')}}" alt="">
                </div>
                <div class="single-brand">
                    <img src="{{asset('images/frontend_images/brand-logo/12.png')}}" alt="">
                </div>
                <div class="single-brand">
                    <img src="{{asset('images/frontend_images/brand-logo/13.png')}}" alt="">
                </div>
                <div class="single-brand">
                    <img src="{{asset('images/frontend_images/brand-logo/7.png')}}" alt="">
                </div>
