...
<head>
    ...
    <body>
        <div id="loginbox">
            ...
            @endif              
            <form id="loginform" class="form-vertical" method="post" action="{{ route('admin_login') }}">
                @csrf
				 <div class="control-group normal_text"> <h3><img src="{{asset('images/backend_images/logo.png')}}" alt="Logo" /></h3></div>
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lg"><i class="icon-user"> </i></span><input type="email" name="email" placeholder="E-mail address" />
                        </div>
                    </div>
                </div>
                <div class="control-group">
